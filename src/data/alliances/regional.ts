...
export const regionalAlliances: Alliance[] = [
  ...
  },
  {
    ...
    dialoguePartners: [
      { code: "AFG", since: 2017 }, { code: "TJK", since: 2017 }
    ]
  },
  {
    id: "eu",
  ...
  },
  {
    ...
    name: "NATO",
    color: "#000080",
    description: "North Atlantic Treaty Organization - intergovernmental military alliance",
    members: [
  ...
  },
  {
    ...
    members: [
      ...
      // Add more African Union members
    ]
  },
  {
    id: "africancorps",
    name: "Africa Corps",
    color: "#556B2F",
    description: "Military presence and operations in specific African regions",
    members: [
      { code: "MLI", joinYear: 2023 }, { code: "BFA", joinYear: 2023 },
      { code: "NER", joinYear: 2023 }
    ]
  }
];

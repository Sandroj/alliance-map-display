...
export const alliances: Alliance[] = [
  ...
  },
  {
    ...
    name: "ICC",
    color: "#8B4513",
    members: ["AFG", "ALB", "AND", "ATG", "ARG", "AUS", "AUT", "BGD", "BRB", "BEL", "BLZ", "BEN", "BOL", "BIH", "BWA", "BRA", "BGR", "BFA", "BDI", "CPV", "KHM", "CMR", "CAN", "CAF", "TCD", "CHL", "COL", "COM", "COG", "COK", "CRI", "HRV", "CYP", "CZE", "COD", "DNK", "DJI", "DMA", "DOM", "ECU", "SLV", "EST", "FJI", "FIN", "FRA", "GAB", "GMB", "GEO", "DEU", "GHA", "GRC", "GRD", "GTM", "GIN", "GUY", "HND", "HUN", "ISL", "IRL", "ITA", "CIV", "JPN", "JOR", "KEN", "LVA", "LSO", "LBR", "LIE", "LTU", "LUX", "MDG", "MWI", "MDV", "MLI", "MLT", "MHL", "MUS", "MEX", "MDA", "MNG", "MNE", "NAM", "NRU", "NLD", "NZL", "NER", "NGA", "MKD", "NOR", "PAN", "PRY", "PER", "PHL", "POL", "PRT", "KOR", "ROU", "KNA", "LCA", "VCT", "WSM", "SMR", "SEN", "SRB", "SYC", "SLE", "SVK", "SVN", "ZAF", "ESP", "LKA", "SWE", "CHE", "TJK", "TZA", "TLS", "TTO", "TUN", "UGA", "GBR", "URY", "VUT", "VEN", "ZMB"]
  },
  {
    id: "bri",
    name: "Belt and Road Initiative",
    color: "#E63946",
    members: ["CHN", "PAK", "BGD", "MMR", "LKA", "NPL", "AFG", "KAZ", "KGZ", "TJK", "UZB", "TKM", "IRN", "IRQ", "SYR", "TUR", "SAU", "EGY", "ETH", "KEN", "TZA", "ZAF", "AGO", "NGA", "DZA", "MAR", "ITA", "GRC", "HUN", "SRB", "POL", "RUS", "MNG", "KHM", "LAO", "THA", "MYS", "IDN", "PHL"]
  },
  {
    id: "quad",
    name: "QUAD",
